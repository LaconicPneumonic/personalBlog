...
<FlexContainer classes="flex flex-col flex-wrap justify-around content-around items-center gap-2">
  <Image
    alt="Gridy Layout"
...
<FlexContainer classes="flex flex-col justify-around content-around items-center md:flex-row flex-wrap gap-2">
