...
So what if we took this process a step further and took the first 100 kaprekar numbers
of length 4 and base 10 and arranged them into a square. This square would have ten
rows and ten columns with varying times to convergence. Here's an example image:
